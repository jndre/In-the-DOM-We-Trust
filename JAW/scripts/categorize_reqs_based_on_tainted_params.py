...
"""
    ...
    Running:
    ------------
    $ python3 -m scripts.categorize_reqs_based_on_tainted_params --source=<SOURCE> --sink=<SINK>
...
def main():
    ...
    p = argparse.ArgumentParser(description='This script analyzes the anatomy of request sending instructions.')
