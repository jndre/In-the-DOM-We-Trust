...
# DATA_DIR = "/data"
# RESULT_DIR = "/mnt/domproject_large_scale/result"
DATA_DIR = os.path.join(BASE_DIR, "data")
RESULT_DIR = os.path.join(BASE_DIR, "result")
PATTERN_DIR = os.path.join(BASE_DIR, "patterns")

TEST_DIR = os.path.join(os.path.join(BASE_DIR, "tests"), "DOM_selectors")

DATA_DIR_UNREPONSIVE_DOMAINS = os.path.join(DATA_DIR, "unresponsive")

CRUX_FILE_PATH = os.path.join(BASE_DIR, "crUX_23August2023.csv")
TRANCO_FILE_PATH = os.path.join(BASE_DIR, "tranco_W8849.csv")
CRAWLING_STORAGE_DIR = os.path.join(BASE_DIR, "data")
...
# solve the delimiter problem of csv files
...
NEW_DELIMITER_NODE_INPUT_FILE_NAME = 'new_delimiter_nodes.csv'
NEW_DELIMITER_RELS_INPUT_FILE_NAME = 'new_delimiter_rels.csv'
NEW_DELIMITER_RELS_DYNAMIC_INPUT_FILE_NAME = 'new_delimiter_rels_dynamic.csv'
